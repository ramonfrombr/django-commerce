    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_bid_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='listings_bid', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Watchlist',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(through='auctions.Watchlist', to='auctions.listing'),
        ),
        migrations.AddField(
            model_name='user',
